...
MACRO_CONFIG_INT(TcGunAimAssist, tc_gun_aim_assist, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Aim shotgun and laser at the closest allowed tee near your cursor")
MACRO_CONFIG_INT(TcGunAimAssistAngle, tc_gun_aim_assist_angle, 8, 1, 30, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Shotgun/laser aim assist cone in degrees")
